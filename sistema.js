  ...
  */
  ...
  function prepararFalhaColetiva(e) {
    ...
    var css = [
      ...
      '#arcane-falha-abertura .fc-time{position:absolute;z-index:4;top:25px;right:25px;display:flex;align-items:center;gap:11px;padding:8px 11px 8px 14px;border-left:1px solid #58f5f0;background:linear-gradient(90deg,rgba(0,6,6,.82),rgba(0,6,6,.28) 78%,transparent);box-shadow:-8px 0 20px rgba(0,0,0,.22);text-align:left;backdrop-filter:blur(1.5px)}#arcane-falha-abertura .fc-time small{max-width:none;white-space:nowrap;color:#f0faf8;font-size:7.5px;font-weight:700;line-height:1.35;letter-spacing:1.35px;text-shadow:0 1px 3px #000,0 0 7px #000}#arcane-falha-abertura .fc-time strong{display:block;margin:0;color:#b8ffda;font:normal 30px/1 "Modern Aesthetic",serif;text-shadow:0 1px 3px #000,0 0 6px rgba(157,255,200,.72),0 0 14px rgba(88,245,240,.38)}',
      ...
      '#arcane-falha-abertura .fc-copy{position:relative;z-index:1;padding:3px 5px 0;color:#c7d1ce;font:400 13.2px/1.4 Poppins,Arial,sans-serif;text-align:justify}#arcane-falha-abertura .fc-copy p{margin:0 0 16px!important;font:400 13.2px/1.4 Poppins,Arial,sans-serif!important;letter-spacing:0!important}#arcane-falha-abertura .fc-copy p:last-child{margin-bottom:0!important}',
      '#arcane-falha-abertura .fc-quote{position:relative;z-index:1;margin:27px 12px 29px;padding:13px 38px;border:0;background:none;color:#a9e9dc;font:normal 17px/1.35 "Modern Aesthetic",serif;text-align:center;text-shadow:-1px 0 rgba(88,245,240,.3),1px 0 rgba(157,255,200,.22),0 0 12px rgba(88,245,240,.12)}#arcane-falha-abertura .fc-quote:before,#arcane-falha-abertura .fc-quote:after{content:"";position:absolute;top:50%;width:25px;height:1px;background:linear-gradient(90deg,transparent,rgba(88,245,240,.55))}#arcane-falha-abertura .fc-quote:before{left:0}#arcane-falha-abertura .fc-quote:after{right:0;transform:scaleX(-1)}#arcane-falha-abertura:after{content:"[ARCANE]"!important;display:block;margin:6px 0 0;color:#969696;font:700 8.5px/normal Consolas,monospace;text-align:center;text-transform:uppercase!important}',
      'html.arcane-evento-falha-coletiva .arcane-me-narracao-falha #rpost-header .poster-name,html.arcane-evento-falha-coletiva .arcane-me-narracao-falha #rpost-header .poster-name>*{color:#eefcfb!important;text-shadow:-2px 0 rgba(88,245,240,.4),2px 0 rgba(157,255,200,.24)!important}html.arcane-evento-falha-coletiva .arcane-me-narracao-falha #rpost-header:before,html.arcane-evento-falha-coletiva .arcane-me-narracao-falha>.inner>.postprofile>.rrank:before{background-color:#173e36!important}html.arcane-evento-falha-coletiva .arcane-me-narracao-falha>.inner>.postprofile>.rrank,html.arcane-evento-falha-coletiva .arcane-me-narracao-falha>.inner>.postprofile>.rrank>*{color:#eefcfb!important;text-shadow:-2px 0 rgba(88,245,240,.4),2px 0 rgba(157,255,200,.24)!important}',
      ...
      '@media(max-width:760px){#arcane-falha-abertura .fc-header{min-height:280px}#arcane-falha-abertura .fc-title{left:22px;bottom:48px}#arcane-falha-abertura .fc-title h1{font-size:39px}#arcane-falha-abertura .fc-time{top:21px;right:19px}#arcane-falha-abertura .fc-body{padding:29px 24px 25px}#arcane-falha-abertura .fc-copy{font-size:12px;text-align:left}#arcane-falha-abertura .fc-copy p{font-size:12px!important}}@media(prefers-reduced-motion:reduce){#arcane-falha-abertura .fc-header:after,#arcane-falha-abertura .fc-title h1,#arcane-falha-abertura .fc-body:after{animation:none!important}}'
    ].join('');
    ...
    if (marcador && !marcador.querySelector('.fc-box')) {
      ...
      marcador.innerHTML = '<div class="fc-box"><div class="fc-header"><div class="fc-time"><small>A ruptura começou às</small><strong>19:07</strong></div><div class="fc-title"><span class="fc-label">Mini-evento</span><h1 data-title="FALHA COLETIVA DE MAGIA">Falha Coletiva<br>de Magia</h1><span class="fc-label">O impossível perdeu a forma</span></div></div><div class="fc-body"><div class="fc-copy"><p>O primeiro sinal não foi um estrondo, mas uma ausência. Em Londres, uma bruxa ergueu a varinha e nenhuma luz surgiu. Em Paris, uma lareira da Rede de Flu lançou uma família no endereço errado. No Ministério da Magia, memorandos perderam as palavras e continuaram voando como folhas em branco.</p><p>Então os relatos chegaram de todas as partes. Vassouras despencaram, retratos fugiram das molduras e proteções antigas se voltaram contra aqueles que deveriam guardar. Quando as luzes voltaram, vieram verdes demais, multiplicadas nos vidros como reflexos partidos. As varinhas continuavam quentes nas mãos de seus donos — mas ninguém podia prever o que responderia ao próximo feitiço.</p></div><blockquote class="fc-quote">A magia não desapareceu. Apenas deixou de obedecer.</blockquote></div></div>';
      var fraseFalha = marcador.querySelector('.fc-quote');
      var paragrafosFalha = marcador.querySelectorAll('.fc-copy p');
      if (fraseFalha && paragrafosFalha.length) paragrafosFalha[0].insertAdjacentElement('afterend', fraseFalha);
    }
